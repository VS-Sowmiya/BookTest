...
namespace PageObjectModel.Source.Pages
{
    public class BookingPage
    {
        ...
        public void Booking()
        {
            ...
            Customertxt.SendKeys("V S Sowmiya");
            Emailtxt.SendKeys("VSSowmiya@adminlucid.com");
            Phonetxt.SendKeys("755-2980090");
            Datetxt.SendKeys("2024"+Keys.ArrowRight+"03"+ Keys.ArrowRight+"18");
            StartTimetxt.SendKeys("05:30AM");
            EndTimetxt.SendKeys("10:30AM");
            Createbtn.Click();
        }
    }
}
